...
namespace menus
{
    public partial class Form1 : Form
    {
        ...
        private void AcercaDe1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Este programa fue creado por Hector Cazadero", "acerca de.... menus", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
